...
C1 =  spearman.toplot(X=R4S.desc$r4s.fungi,Y=R4S.desc$r4s.yk11)
F1 = ggplot(R4S.desc) + 
...
F6 = ggplot(SNP.PROT) + 
     geom_point(aes(x=nsnp,y=r4s.fungi,text=orf,func=FUNCTION), color='white', fill=NA,,shape=21,size=0.8) + 
...
F7 = ggplot(SNP.PROT) + 
     geom_point(aes(x=nsnp,y=r4s.yk11,text=orf,func=FUNCTION), color='white', fill=NA,,shape=21,size=0.8) + 
     xlab('SNP count') + ylab("1011 strains evolutionary rate") + 
     scale_y_log10() + scale_x_continuous(trans='log2') +
     theme_black()
...
F8 = ggplot(SNP.PROT) + 
     geom_point(aes(y=nsnp,x=log10_median.mpc,text=orf,func=FUNCTION), color='white', fill=NA,,shape=21,size=0.8) + 
...
F9 = ggplot(SNP.PROT) + 
     geom_point(aes(y=r4s.yk11,x=log10_median.mpc,text=orf,func=FUNCTION), color='white', fill=NA,,shape=21,size=0.8) + 
     ylab("1011 strains evolutionary rate") + xlab('Molecules per cell (log10 median)') +
     scale_y_log10() +
     theme_black()
ggplotly(F9)
...
F10 = ggplot(SNP.PROT) + 
     geom_point(aes(y=r4s.fungi,x=log10_median.mpc,text=orf,func=FUNCTION), color='white', fill=NA,,shape=21,size=0.8) + 
