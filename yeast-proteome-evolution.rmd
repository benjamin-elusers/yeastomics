...
p2.0 = ggplot(snp_byfreq, aes(x=1,fill=fr_bin)) + 
...
p2.1 = ggplot(snp_byfreq, aes(x=fr_bin,fill=fr_bin)) + 
...
p4.1 = get_snp_protlen_anim(animated=T,psnp=PROT_SNP)
...
PLOTS = tribble( ~ggplot, ~fname,
p0.0, '0.0_var_count.png', 
p0.1, '0.1_var_prop.png', 
p1.0, '1.0_var_count_by_freq_stacked.png', 
'1.1_var_count_by_freq.png', p1.1,
'2.0_var_prop_by_freq_stacked.png', p2.0,
'2.1_var_prop_by_freq.png',   p2.1,
'3.0_snp_orf.png',p3.0,
'3.1_snp_orf_by_minfreq.png',p3.1,
'4.0_snp_protlen.png', p4.0,
'4.1_snp_protlen.gif', p4.1,
'5.0_snp_pos.png', p5.0,
'5.1_snp_pos_by_minfreq', p5.1,

'6.0_evo_fungi_vs_pop.png', p6.0,
'6.1_evo_fungi_snp.png', p6.1,
'6.2_evo_pop_snp.png', p6.2,

'7.0_snp_exp.png', p7.0,
'7.1_evo_pop_exp.png', p7.1,
'7.2_evo_fungi_exp.png', p7.2,
)

for( p in 1:nrow(PLOTS) ){
SCALE_PLOT=1.2
ggsave(path = path.plot,plot = p0, filename = "0_var_count.png",scale = SCALE_PLOT)
...
# plot(F12)
# plot(F13)
ggsave(path = path.plot,plot = p00, filename = "00_var_prop.png",scale = SCALE_PLOT)
ggsave(path = path.plot,plot = p1, filename = "1_freq_by_var_count.png",scale = SCALE_PLOT)
ggsave(path = path.plot,plot = p2, filename = "2_var_count_by_freq.png",scale = SCALE_PLOT)
ggsave(path = path.plot,plot = p3, filename = "3_var_prop.png",scale = SCALE_PLOT)
ggsave(path = path.plot,plot = p4, filename = "4_var_prop_by_freq.png",scale = SCALE_PLOT)
ggsave(path = path.plot, filename = '5_snp_hist.png', plot=F3, scale = SCALE_PLOT)

ggsave(path = path.plot, filename = '6_snp_protlen.png', plot=F4, scale = SCALE_PLOT)
p6.1 =  get_snp_pos_plot()
ggsave(path = path.plot, filename = '6.1_snp_protlen.png', plot=p6.1, scale = SCALE_PLOT)
#outfile =file.path("plots/6_snp_protlen.gif")
#anim_save(outfile, animation =  anim )

ggsave(path = path.plot, filename = '7_snp_pos.png', plot=F5, scale = SCALE_PLOT)
outfile =file.path("plots/7_snp_pos.gif")
anim_save(outfile, animation =  get_snp_pos_anim())

ggsave(path = path.plot, filename = '8_evo_fungi_pop.png', F1,scale=SCALE_PLOT )
ggsave(path = path.plot, filename = '9_evo_fungi_snp.png', F9,scale=SCALE_PLOT/2 )
ggsave(path = path.plot, filename = '10_evo_pop_snp.png', F10,scale=SCALE_PLOT/2 )


ggsave(path = path.plot, filename = '11_snp_exp.png', F11,scale=SCALE_PLOT )
ggsave(path = path.plot, filename = '12_evo_pop_exp.png', F12,scale=SCALE_PLOT/2 )
ggsave(path = path.plot, filename = '13_evo_fungi_exp.png', F13,scale=SCALE_PLOT/2 )
