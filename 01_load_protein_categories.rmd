...
check_chunk =function(df,LIST,extra.verbose=F){
  ...
  if( !is.null(LIST) ){
    prop.stats = sprintf("%s for %s proteins in total", length(LIST), n_distinct(unlist(LIST)))
    cat0("\nPROPERTIES:\n##########\n",prop.stats,"##########\n")
    if(extra.verbose){
...
check_chunk(df=NULL,PHENOTYPES)
